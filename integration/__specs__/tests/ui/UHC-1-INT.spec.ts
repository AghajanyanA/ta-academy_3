...
import { ModalAddItem, TestDataID } from '@Components/cartPage/ModalAddItem/ModalAddItem';
...
describe('UHC-0-int', () => {
    ...
    test('Test title', async () => {
        ...
        reporter.startStep('Check that a new product has been added, and all fields (name, price, quantity) are displayed correctly')
