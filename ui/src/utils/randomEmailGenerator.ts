const emailUsername = 'qwertyuiopoasdfghjklzxcvbnm0123456789';
...
const getRandomNumber = (max: number): number => {
    // get random number from 2 to max
...
export const generateEmail = (length: number): string => {
    ...
    for (let i = 0; i < length; i++) {
        // form random email username consisted of lowercase letters and numbers
